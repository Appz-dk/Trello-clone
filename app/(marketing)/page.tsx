  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className={cn(
        ...
        Collaborate, manage projects and reach new productivity peaks. From high rises to the home office, the way your team works is unique - accomplish it all with {siteName}.
      </div>
      <Button className="mt-6" size={"lg"} asChild>
        <Link href="/sign-up">Get {siteName} for free</Link>
      </Button>
    </div>
  )
}
